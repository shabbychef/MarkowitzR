...
```{r marko_ism,cache=TRUE,eval=TRUE,echo=TRUE,dpi=200,out.width='600px',out.height='500px'}
...
library(Quandl)
ff.data <- Quandl("KFRENCH/FACTORS_M",
	start_date="1926-07-31",end_date="2014-12-31",
	type="xts")
